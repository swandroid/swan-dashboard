 ...
 */
public class ReligiousMeetingPointsInformationCard extends LandmarksInformationCard {

    public ReligiousMeetingPointsInformationCard(int id, final Context context) {
        super(id,
                context,
                context.getResources().getString(R.string.activity_title_religious_meeting_points),
                context.getResources().getString(R.string.religious_meeting_points),
                ((MainActivity)context).prefs.getString(
                        context.getResources().getString(R.string.preference_key_religious_meeting_points),
                ...
                new InformationCardStrategy() {
                    ...
                    private void processNewLocation(final int positionInGrid) {
                        RequestManager requestManager =
                                new RequestManager(
                                        context,
                                        r.getString(R.string.religious_meeting_points_api_url),
                                        origin,
                                        new RequestManagerHandlers() {
                                            ...
                                            public void onPostExecute(Context context, String result) {
                                                ...
                                                try {
                                                    ...
                                                    editor.putString(
                                                            r.getString(R.string.preference_key_religious_meeting_points),
                                                            value
                                                    );
                                                    editor.commit();
