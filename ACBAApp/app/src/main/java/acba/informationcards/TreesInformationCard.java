 ...
 */
public class TreesInformationCard extends LandmarksInformationCard {

    public TreesInformationCard(int id, final Context context) {
        super(id,
                context,
                context.getResources().getString(R.string.activity_title_monumental_trees),
                context.getResources().getString(R.string.monumental_trees),
                ((MainActivity)context).prefs.getString(
                        context.getResources().getString(R.string.preference_key_monumental_trees),
                ...
                new InformationCardStrategy() {
                    ...
                    private void processNewLocation(final int positionInGrid) {
                        RequestManager requestManager =
                                new RequestManager(
                                        context,
                                        r.getString(R.string.monumental_trees_api_url),
                                        origin,
                                        new RequestManagerHandlers() {
                                            ...
                                            public void onPostExecute(Context context, String result) {
                                                ...
                                                editor.putString(
                                                        r.getString(R.string.preference_key_monumental_trees),
                                                        value
                                                );
                                                editor.commit();
